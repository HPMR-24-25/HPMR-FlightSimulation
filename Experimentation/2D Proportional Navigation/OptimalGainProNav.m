% could probably make a program that runs until it finds an N that makes
% miss distance less than a certain distance [ft]. Once this distance
% is found I can then run the plot to achieve the required distnce
...
% relative positions and velocities
Rtpx = xRec_FPPN(2,:) -  xRec_FPPN(4,:);
Rtpz = xRec_FPPN(3,:) -  xRec_FPPN(5,:);
...
hold on
plot(xRec_FPPN(2,1:midx_FPPN), xRec_FPPN(3,1:midx_FPPN),'linewidth', 2);
